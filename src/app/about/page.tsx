  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div>
          <p className="mb-4">
            Dream Home Realty has been serving our community for over 20 years.
            We&apos;re committed to helping you find the perfect place to call
            home, whether you&apos;re buying, selling, or renting.
          </p>
          <p className="mb-4">
